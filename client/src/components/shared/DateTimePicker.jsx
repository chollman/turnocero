...
export default function DateTimePicker({
  ...
  const triggerLabel = selectedDate ? formatTrigger(selectedDate) : 'Elegí fecha y hora';
  ...
  return (
    <div className={styles.wrapper} ref={wrapperRef}>
      ...
      >
        <span className={styles.triggerIcon}><CalendarIcon /></span>
      ...
      {open && (
        ...
        >
            ...
            {days.map((d, i) => {
              ...
              return (
                <button
                  ...
                  aria-label={d.date.toLocaleDateString('es-AR', { weekday: 'long', day: 'numeric', month: 'long' })}
          ...
          <div className={styles.timeRow}>
            <span className={styles.timeIcon} aria-hidden="true"><ClockIcon /></span>
            <select
