...
const SECTION_META = [
  {
    ...
    items: [
      { key: 'compartidas', label: 'Compartidas',
        ...
        affects: ['Oculta /compartidas, /', 'Oculta links/widgets a compartidas en perfiles', 'Bloquea notificaciones (comentario, like)'] },
      ...
      { key: 'torneos', label: 'Torneos',
        ...
        affects: ['Oculta /torneos y subrutas', 'Bloquea notificaciones (aceptado, eliminado, avanzado, etc.)'] },
      { key: 'mesas', label: 'Mesas',
        desc: 'Mesas para organizar partidas (con chat, comentarios, fotos).',
        affects: ['Oculta /mesas', 'Oculta widget de mesa dentro de compartidas (linkedTable)', 'Oculta stats de mesas en perfiles', 'Bloquea notificaciones de chat, comentarios, joins, etc.'] },
      { key: 'miFeed', label: 'Mi Feed',
  ...
  },
  {
    group: 'Integraciones',
    items: [
      { key: 'bgwatch', label: 'BG Watch',
        desc: 'Integración con BoardGameGeek (perfil, partidas, colección).',
        affects: ['Oculta /bg-watch', 'Oculta el badge/banner BG Watch en perfiles', 'Oculta link al BG Watch del autor en compartidas', 'Oculta sección "Conexión con BGG" en /perfil'] },
...
function SectionToggle({ section, enabled, busy, onToggle }) {
  return (
    <div className={`${styles.sectionCard} ${enabled ? styles.sectionCardOn : styles.sectionCardOff}`}>
      ...
      <div className={styles.affects}>
        <span className={styles.affectsLabel}>{enabled ? 'Si la apagás:' : 'Mientras esté apagada:'}</span>
      ...
      <div className={styles.inner}>
        <div className={styles.hero}>
          ...
          <p className={styles.sub}>
            Prendé o apagá secciones del sitio para usuarios no-admin. Vos seguís viendo todo
            (salvo que actives <em>"Ver como usuario"</em>). Los cambios se reflejan en tiempo real para
