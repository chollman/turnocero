  ...
  return (
    <div className={`${styles.inlineWidget} ${styles.gold}`}>
      ...
      <div className={styles.quoteAttribution}>
        <span>— <strong>{QUOTE.authorName}</strong> · {QUOTE.game}</span>
      </div>
    </div>
  )
}
        ...
        <div className={styles.feedCol}>
          ...
          <header className={styles.pageHead}>
            <div className={styles.heroBlock}>
              <span className={styles.pageEyebrow}>Comunidad · diario compartido</span>
            ...
            <div className={styles.heroStats}>
              <div className={styles.heroStatRow}>
                <div className={styles.heroStat}>
                  <div className={`${styles.heroStatVal} ${styles.heroStatValAccent}`}>
                    {total || visiblePosts.length + (featured ? 1 : 0)}
                  </div>
                  <div>Compartidas</div>
                </div>
                <div className={styles.heroStat}>
                  <div className={styles.heroStatVal}>{weekCount}</div>
                  <div>Esta semana</div>
                </div>
              </div>
            </div>
