// Íconos inline del PlayForm (sin libs de iconos — convención del repo).
// Todos heredan currentColor. Extraídos de PlayForm.jsx para alivianarlo.
...
export function SaveAnotherIcon() {
  return (
    <svg
      width="16"
      height="16"
