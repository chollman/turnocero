...
beforeEach(() => {
  server.use(
    http.get('/api/bgg/search', () =>
      HttpResponse.json([
        { id: 13, name: 'Catán', thumbnail: 'https://cdn/catan.jpg', year: 1995 },
...
describe('<CreatePlayModal>', () => {
  ...
  it('renders the edit-mode title and skips step 1 when editPlay is provided', () => {
    renderModal({
      editPlay: { id: 'pl1', gameId: 13, gameName: 'Catán', gameThumbnail: 'https://cdn/c.jpg', date: '2026-05-01', players: [] },
    });
  ...
  it('submits an edit (PUT) when editPlay is provided', async () => {
    ...
    renderModal({
      editPlay: {
        ...
        gameName: 'Catán',
        date: '2026-05-01',
        players: [{ name: 'X', username: '', color: '', score: '', win: false, new: false }],
      },
      onCreated,
    });
