...
describe('<Dado>', () => {
  it('renders the 6 dice type buttons (d4..d20) with d6 active by default', () => {
    ...
    expect(screen.getByRole('button', { name: 'd6' }).className).toMatch(/active/i);
  });
  ...
  it('count + and − change the dice quantity, clamped to 1..5', () => {
    ...
    fireEvent.click(plus); fireEvent.click(plus); fireEvent.click(plus); fireEvent.click(plus); fireEvent.click(plus); fireEvent.click(plus);
