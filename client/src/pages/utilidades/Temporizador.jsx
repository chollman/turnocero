    ...
    <div className={`${styles.screen} ${isDone ? styles.screenDone : ''}`}>
      ...
      <div className={styles.content}>
        <div className={styles.ringWrap}>
          ...
          <div className={styles.timeInner}>
            {isDone
              ...
              : <span className={styles.timeText}>{String(mins).padStart(2, '0')}:{String(secs).padStart(2, '0')}</span>
            }
          </div>
        </div>
        ...
        <div className={styles.controls}>
          ...
          {phase === 'running' && (
            <button className={styles.btnSecondary} onClick={pause} type="button">Pausar</button>
          )}
          {phase === 'done' && (
            <button className={styles.btnPrimary} onClick={reset} type="button">De nuevo</button>
          )}
          {(phase === 'running' || phase === 'paused') && (
            <button className={styles.btnGhost} onClick={reset} type="button">Reiniciar</button>
          )}
        </div>
      </div>
    </div>
