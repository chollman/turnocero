...
export default function CreateTorneo() {
  ...
  return (
    <div className={styles.page}>
      <Helmet><title>Nuevo torneo – Turnocero</title></Helmet>
      <div className={styles.inner}>
        <div className={styles.formHeader}>
          <Link to="/torneos" className={styles.backLink}>← Volver a torneos</Link>
          <h1 className={styles.title}>Crear torneo</h1>
          <p className={styles.sub}>Configurá los datos básicos. Vas a poder abrir inscripciones y armar el fixture desde la página del torneo.</p>
        </div>
        ...
        <form className={styles.formCard} onSubmit={handleSubmit}>
            ...
            <label className={styles.field}>
              ...
              <div className={styles.formatOptions}>
                ...
                >
                  ...
                  <span className={styles.formatHint}>1vs1 todos contra todos · 3/1/0</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className={styles.formatHint}>Bracket 1vs1 con byes</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className={styles.formatHint}>Mesas multijugador · multi-fase · cut por puntaje</span>
                </button>
              </div>
            </label>
          </div>
          ...
          {format === 'groups' && (
            <div className={styles.groupsConfig}>
              <h3 className={styles.groupsConfigTitle}>Configuración del formato Grupos</h3>
              <div className={styles.groupsConfigGrid}>
                <label className={styles.field}>
                  <span className={styles.fieldLabel}>Jugadores por mesa (X)</span>
                  <input
                    className={styles.fieldInput}
                    type="number"
                    min={2}
                ...
                <label className={styles.field}>
                  <span className={styles.fieldLabel}>Partidas por grupo (P)</span>
                  <input
                    className={styles.fieldInput}
                    type="number"
                    min={1}
                ...
                <label className={styles.field}>
                  <span className={styles.fieldLabel}>Clasificados por grupo (C)</span>
                  <input
                    className={styles.fieldInput}
                    type="number"
                    min={1}
              ...
              <p className={styles.groupsConfigHint}>
                Al iniciar el torneo se generan ⌈N/X⌉ grupos. Después de las P partidas, los C mejores de cada grupo pasan a la siguiente fase.
              </p>
            </div>
          )}
          ...
          <label className={styles.field}>
            ...
            <div className={styles.formatOptions}>
              ...
              >
                ...
                <span className={styles.formatHint}>Los usuarios se anotan y vos aprobás</span>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <span className={styles.formatHint}>Vos elegís a quién agregar de la comunidad</span>
              </button>
            </div>
          </label>
          ...
          <div className={styles.formActions}>
            <Link to="/torneos" className={styles.btnGhost}>Cancelar</Link>
            <button type="submit" className={styles.btnPrimary} disabled={submitting}>
              {submitting ? 'Creando…' : 'Crear torneo'}
            </button>
          </div>
          <p className={styles.formHint}>
            Se crea como <strong>Borrador</strong>. Después podés abrir inscripciones desde la página del torneo.
          </p>
        </form>
      </div>
    </div>
