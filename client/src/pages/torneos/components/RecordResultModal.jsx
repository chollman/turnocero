...
export default function RecordResultModal({ match, format, onClose, onConfirm }) {
  ...
  useEffect(() => { setChoice(null); setError('') }, [match?._id])

  if (!match) return null

  const handleConfirm = async () => {
    if (!choice) { setError('Elegí un resultado'); return }
      ...
      <div className={styles.modalCard} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.choiceGroup}>
          ...
          >
            ...
            <span className={styles.choicePlayer}><UserRef user={match.playerA} noLink /></span>
          </button>
          ...
          >
            <span className={styles.choiceLabel}>Ganó</span>
            <span className={styles.choicePlayer}><UserRef user={match.playerB} noLink /></span>
          </button>
        ...
        <div className={styles.modalActions}>
          ...
          <button className={styles.btnPrimary} onClick={handleConfirm} disabled={submitting || !choice}>
