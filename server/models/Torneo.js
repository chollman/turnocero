...
const torneoSchema = new mongoose.Schema(
  {
    ...
    format:      { type: String, enum: ['league', 'single_elim', 'groups'], required: true },
    status: {
      type: String,
    ...
    rejectedRegistrations: [{ type: mongoose.Schema.Types.ObjectId, ref: 'User' }],

    winner:   { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null },
    runnerUp: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null },
  },
  { timestamps: true }
);
