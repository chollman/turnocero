...
- [Google Maps setup](feedback_google_maps_setup.md) — reemplazó Leaflet + Nominatim en 2026-05; `AddressMap` + `PlaceAutocomplete` componentes shared, server-side geocoding con cache Mongo, 2 Map IDs (dark/light) en Cloud Console; siempre leer `import.meta.env` dentro del render para permitir `vi.stubEnv` en tests
