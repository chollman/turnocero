      ...
      >
        ...
        <div
          style={{
            fontSize: 11,
            fontWeight: 600,
            color: csTheme.textSub,
            marginTop: 4,
            borderTop: `1px dashed ${csTheme.border}`,
            paddingTop: 4,
          }}
        >
          {time}
  ...
  return (
    <span
      style={{
        ...
        background: full ? "rgba(243,29,119,0.08)" : "rgba(0,217,132,0.08)",
      }}
    >
      <span
        style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            ...
            {table.privacy === "private" && (
              <span
                title="Privada"
                style={{ color: csTheme.textMute, flexShrink: 0 }}
              >
                <Icon.Lock size={13} />
              </span>
            )}
          ...
          >
            ...
            <span style={{ color: csTheme.text, fontWeight: 600 }}>
              {table.host}
            </span>
      ...
      >
        ...
        {table.joined ? (
          ...
          <button
            style={{
              background: "transparent",
              border: `1px solid ${csTheme.accent}`,
              color: csTheme.accent,
              padding: "7px 14px",
              borderRadius: 6,
              fontWeight: 600,
              fontSize: 12,
        ...
        <span style={{ color: csTheme.textSub, position: "relative" }}>
          ...
          <span
            style={{
              ...
              width: 8,
              height: 8,
              background: csTheme.red,
              borderRadius: 999,
              border: `2px solid ${csTheme.bg}`,
            }}
          />
        </span>
        <div
        ...
        >
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            <div style={{ position: "relative" }}>
              ...
              <input
                placeholder="Buscar juego, host o lugar"
                style={{
                  background: csTheme.bgCard,
                  border: `1px solid ${csTheme.border}`,
                  borderRadius: 8,
            ...
            {["Todas", "Mis mesas", "Hospedando", "Pasadas"].map((t, i) => (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  color: i === 0 ? csTheme.text : csTheme.textSub,
                  fontSize: 12,
                  fontWeight: 600,
                  fontFamily: "Manrope, sans-serif",
                  letterSpacing: "0.02em",
              ...
              >
                {t}
                {i === 1 && (
                  <span style={{ marginLeft: 6, color: csTheme.accentLight }}>
                    2
                  </span>
                )}
              </button>
      ...
      >
        ...
        >
          {window.MOCK_TABLES.slice(0, 4).map((t) => (
            <CSTableCard key={t.id} table={t} compact />
          ))}
        </div>
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, padding: "24px 36px", overflow: "auto" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    border: `1px solid rgba(0,217,132,0.3)`,
                  }}
                >
                  TE UNISTE
                </span>
              ...
              >
                ...
                >
                  ...
                  >
                    <Icon.Pin size={14} />
                    <span style={{ color: csTheme.text }}>{t.location}</span>
                  </div>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <span>
                      Host:{" "}
                      <strong style={{ color: csTheme.text }}>{t.host}</strong>
                    </span>
                  </div>
                </div>
          ...
          <div style={{ marginTop: 24 }}>
            ...
            >
              JUGADORES · {t.players + 1}/{t.maxPlayers + 1}
            </h3>
            <div style={{ display: "flex", gap: 10 }}>
              {window.MOCK_PLAYERS.map((p, i) => (
                <div
                  ...
                  style={{
                    ...
                    gap: 10,
                    background: csTheme.bgCard,
                    border: `1px solid ${p.you ? csTheme.accent : csTheme.border}`,
                    borderRadius: 10,
              ...
              <div
                style={{
                  ...
                  justifyContent: "center",
                  width: 52,
                  border: `1.5px dashed ${csTheme.border}`,
                  borderRadius: 10,
                  color: csTheme.textMute,
                }}
              >
          ...
          <div style={{ marginTop: 28, marginBottom: 24 }}>
            ...
            >
              ...
              >
                {[1, 2, 3, 4, 5].map((s) => (
                  <Icon.Star key={s} size={12} filled={s <= 4} />
                ))}
                <span style={{ marginLeft: 4 }}>4.5</span>
                <span style={{ color: csTheme.textMute, fontWeight: 500 }}>
                  · 2 reseñas
                </span>
              </span>
            </div>
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      ...
                      >
                        {[1, 2, 3, 4, 5].map((s) => (
                          <Icon.Star key={s} size={11} filled={s <= r.score} />
                        ))}
                      </span>
                    </div>
                    <p
        ...
        <div
          style={{
            width: 380,
            borderLeft: `1px solid ${csTheme.border}`,
            background: csTheme.bgCard,
            backgroundImage: grain,
            display: "flex",
            flexDirection: "column",
            ...
            {["Info", "Chat", "Fotos", "Reseñas"].map((tab, i) => (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  color: i === 1 ? csTheme.text : csTheme.textSub,
                  fontSize: 11,
                  fontWeight: 700,
                  fontFamily: "Manrope, sans-serif",
                  letterSpacing: "0.04em",
