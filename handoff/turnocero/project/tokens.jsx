...
function Meeple({ char, size = 36, color = tkTheme.accent }) {
  return (
    ...
    >
      ...
      >
        <path
          d="M20 4c-3 0-5 2-5 5 0 2 1 3 2 4-3 1-7 3-7 7v3h4v13h12V23h4v-3c0-4-4-6-7-7 1-1 2-2 2-4 0-3-2-5-5-5z"
          fill={color}
        />
      </svg>
      <div
  ...
  return (
    <div
      style={{
        ...
        boxShadow:
          "0 8px 24px rgba(0,0,0,0.3), 0 1px 0 rgba(255,255,255,0.04) inset",
        position: "relative",
      ...
      <div style={{ position: "relative", height: 92, overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(180deg, rgba(0,0,0,0) 30%, rgba(18,24,38,0.7) 70%, rgba(18,24,38,1) 100%)",
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            ...
            {table.weekday} · {table.dateShort.split(" ")[0]}{" "}
            {table.dateShort.split(" ")[1]} · {table.time}
          </div>
          <div style={{ display: "flex", gap: 6 }}>
            {table.hosted && (
              <span
                style={{
                  background: tkTheme.accent,
                  color: "#fff",
                  padding: "4px 8px",
                  borderRadius: 6,
                  fontFamily: "Manrope, sans-serif",
            ...
            {table.joined && (
              <span
                style={{
                  background: "rgba(0,217,132,0.18)",
                  color: tkTheme.green,
                  padding: "4px 8px",
                  borderRadius: 6,
                  border: `1px solid ${tkTheme.green}`,
                  fontFamily: "Manrope, sans-serif",
                  fontSize: 9,
                  fontWeight: 800,
                  letterSpacing: "0.08em",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span
                style={{ fontSize: 12, fontWeight: 600, color: tkTheme.text }}
              >
                {table.host}
              </span>
          ...
          {table.joined ? (
            <button
              style={{
                background: tkTheme.bgElev,
                border: `1px solid ${tkTheme.borderHi}`,
                color: tkTheme.text,
                padding: "8px 14px",
                borderRadius: 8,
                fontWeight: 600,
            ...
            <button
              style={{
                background: tkTheme.bgElev,
                border: `1px solid ${tkTheme.accent}`,
                color: tkTheme.accentLight,
                padding: "8px 14px",
                borderRadius: 8,
                fontWeight: 700,
                fontSize: 12,
            ...
            >
              {table.privacy === "private" ? "Solicitar" : "Unirme"}
            </button>
          )}
        </div>
      </div>
  ...
  return (
    <div
      style={{
        width: 220,
        background: tkTheme.bgCard,
        borderRight: `1px solid ${tkTheme.border}`,
        display: "flex",
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 11, color: tkTheme.textSub, marginTop: 2 }}>
          Sáb · 21:00 · 2d
        </div>
      </div>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 10, color: tkTheme.textMute }}>
            14 partidas · 4.8 ★
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, overflow: "auto", padding: "28px 36px" }}>
        ...
        >
          {window.MOCK_TABLES.slice(0, 6).map((t) => (
            <TKTableCard key={t.id} table={t} />
          ))}
        </div>
      </div>
    </div>
      ...
      >
        ...
        <div
          style={{
            ...
            display: "flex",
            gap: 18,
            borderBottom: `1px solid ${tkTheme.border}`,
          }}
        >
          {[
            { label: "Todas", count: 12, active: true },
            ...
            >
              {t.label}
              <span style={{ color: tkTheme.textMute, fontWeight: 500 }}>
                {t.count}
              </span>
            </button>
          ))}
        ...
        >
          {window.MOCK_TABLES.slice(0, 4).map((t) => (
            <TKTableCard key={t.id} table={t} />
          ))}
        </div>
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                alignItems: "center",
                gap: 4,
                color: n.active ? tkTheme.accentLight : tkTheme.textMute,
                position: "relative",
                fontFamily: "Manrope, sans-serif",
                fontSize: 10,
                fontWeight: 700,
    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(180deg, rgba(8,11,19,0.4) 0%, rgba(8,11,19,0.7) 60%, " +
                  tkTheme.bg +
                  " 100%)",
              }}
            />
            ...
            >
              <div>
                ...
                >
                  ...
                  >
                    <Icon.Calendar size={13} /> {t.weekday} {t.dateShort} ·{" "}
                    {t.time}
                  </span>
                  <span
                    style={{ display: "flex", alignItems: "center", gap: 6 }}
                  >
                    <Icon.Pin size={13} /> {t.location}
                  </span>
                </div>
              </div>
              <button
          ...
          <div style={{ padding: "24px 32px 32px" }}>
            ...
            >
              ...
              >
                ...
                >
                  {t.seats === 0
                    ? "Mesa completa"
                    : `${t.seats} lugar${t.seats !== 1 ? "es" : ""} libre${t.seats !== 1 ? "s" : ""}`}
                </p>
              </div>
            </div>
                ...
                {window.MOCK_PLAYERS.map((p, i) => (
                  ...
                  >
                    <Meeple
                      char={p.avatar}
                      size={56}
                      color={i % 2 === 0 ? tkTheme.accent : tkTheme.purple}
                    />
                ...
                >
                  <div
                    style={{
                      ...
                      height: 56,
                      borderRadius: 14,
                      border: `1.5px dashed ${tkTheme.border}`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      color: tkTheme.textMute,
            ...
            <div style={{ marginTop: 28 }}>
              ...
              >
                ...
                >
                  {[1, 2, 3, 4, 5].map((s) => (
                    <Icon.Star key={s} size={13} filled={s <= 4} />
                  ))}
                  <span
                    style={{
                      fontFamily: "Manrope, sans-serif",
                  ...
                  <span style={{ color: tkTheme.textMute, fontSize: 12 }}>
                    · 2 reseñas
                  </span>
                </span>
              </div>
        ...
        <div
          style={{
            width: 360,
            borderLeft: `1px solid ${tkTheme.border}`,
            background: tkTheme.bgCard,
            display: "flex",
            flexDirection: "column",
          }}
        >
          ...
          >
            ...
            {window.MOCK_MESSAGES.map((m) => (
              ...
              >
                {!m.own && (
                  <Meeple char={m.avatar} size={26} color={tkTheme.accent} />
                )}
                <div
                  style={{
                    maxWidth: 220,
      ...
      >
        ...
        >
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: `linear-gradient(180deg, rgba(8,11,19,0.3) 0%, rgba(8,11,19,0.7) 60%, ${tkTheme.bg} 100%)`,
            }}
          />
          <div
            style={{
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "12px 16px 100px" }}>
          ...
          >
            ...
            >
              <Icon.Pin size={14} />
              <span style={{ color: tkTheme.text }}>{t.location}</span>
            </div>
          </div>
            ...
            {["Chat", "Fotos", "Reseñas"].map((tab, i) => (
              <button
                ...
                style={{
                  flex: 1,
                  padding: "10px 0",
                  borderBottom: `2px solid ${i === 0 ? tkTheme.accent : "transparent"}`,
                  background: "transparent",
                  border: "none",
                  borderTop: "none",
                  borderLeft: "none",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {window.MOCK_MESSAGES.slice(0, 3).map((m) => (
              ...
              >
                {!m.own && (
                  <Meeple char={m.avatar} size={24} color={tkTheme.accent} />
                )}
