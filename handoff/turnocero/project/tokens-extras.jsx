          ...
          >
            <span
              style={{
                width: 18,
                textAlign: "center",
                color: a ? T.accentLight : T.textMute,
                fontSize: 13,
              }}
            >
              {it.icon}
      ...
      >
        ...
        >
          ...
          >
            ...
            <a style={{ color: T.accentLight, fontWeight: 600 }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <Btn ghost full>
              <span style={{ fontSize: 14 }}>✦</span> Discord
            </Btn>
          </div>
          <p
            style={{
          ...
          >
            ¿No tenés cuenta?{" "}
            <a style={{ color: T.accentLight, fontWeight: 700 }}>
              Crear cuenta →
            </a>
          </p>
        </div>
      ...
      >
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: `linear-gradient(135deg, rgba(8,11,19,0.5), rgba(8,11,19,0.85))`,
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              <div>
                <div style={{ ...fontDisp, fontWeight: 700, fontSize: 15 }}>
                  {t.game}
                </div>
            ...
            >
              ...
              >
                ● {t.maxPlayers - t.players} LUGARES
              </span>
              <span style={{ fontSize: 11, color: T.textSub }}>
                {t.weekday} {t.dateShort} · {t.time}
              </span>
            </div>
          </div>
        </div>
    ...
    <_PhoneFrame theme={T.bg}>
      ...
      >
        ...
        >
          ...
          <Input label="Contraseña" value="••••••••••" type="password" />
          <Btn primary full>
            <span style={{ fontSize: 13 }}>🎲</span> Entrar
          </Btn>
        ...
        <div style={{ maxWidth: 760 }}>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <span
                    style={{ color: T.textSub, fontSize: 12, marginLeft: 6 }}
                  >
                    Total: 4
                  </span>
                </div>
            ...
            <div>
              ...
              <textarea
                readOnly
                defaultValue="Partida tranquila, nivel intermedio. Traigan ganas. Hay café y picada del lugar."
                style={{
                  background: T.bgInset,
                  border: `1px solid ${T.border}`,
                  borderRadius: 9,
              ...
              >
                ...
                >
                  ...
                  >
                    <span style={{ fontSize: 16 }}>🔒</span>
                    <span
                      style={{ ...fontDisp, fontWeight: 700, fontSize: 14 }}
                    >
                      Privada
                    </span>
                  </div>
            ...
            >
              ...
              <Btn primary>
                {editMode ? "Guardar cambios" : "🎲 Crear mesa"}
              </Btn>
            </div>
          </div>
        </div>
    ...
    <_PhoneFrame theme={T.bg}>
      ...
      >
        ...
        >
          ...
          <span style={{ ...fontDisp, fontWeight: 700, fontSize: 14 }}>
            {editMode ? "Editar mesa" : "Nueva mesa"}
          </span>
          <span style={{ width: 40 }} />
        </div>
        ...
        >
          <div>
            <div style={eyebrow()}>
              ◆ {editMode ? "EDITAR" : "CONVOCÁ JUGADORES"}
            </div>
            <h1
              style={{
                ...fontDisp,
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {POPULAR.map((g) => {
              const a =
                g === sel || (g === "TM" && sel === "Terraforming Mars");
              return (
                <span
                  key={g}
                  style={{
          ...
          {editMode && (
            <Btn ghost full>
              <span style={{ color: T.red }}>Eliminar mesa</span>
            </Btn>
          )}
        </div>
      </div>
        ...
        <div style={{ position: "relative", height: 220, overflow: "hidden" }}>
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: `linear-gradient(180deg, rgba(8,11,19,0.3), ${T.bg})`,
            }}
          />
        </div>
        <div
          ...
          >
            ...
            <div style={{ flex: 1, paddingBottom: 12 }}>
              ...
              <div style={{ color: T.textSub, fontSize: 14 }}>
                @yago · Palermo, CABA · 📞 Telegram conectado
              </div>
            </div>
              ...
              >
                {hostedTables.map((t) => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      <div
                        style={{ ...fontDisp, fontWeight: 700, fontSize: 15 }}
                      >
                        {t.game}
                      </div>
                      <div
                      ...
                      >
                        {t.weekday} {t.dateShort} · {t.players + 1}/
                        {t.maxPlayers + 1} jugadores · {t.location}
                      </div>
                    </div>
                    <span
                      style={{
        ...
        <div style={{ position: "relative", height: 140, overflow: "hidden" }}>
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: `linear-gradient(180deg, rgba(8,11,19,0.4), ${T.bg})`,
            }}
          />
          <div
            style={{
        ...
        <div style={{ padding: "0 22px 90px", marginTop: -56 }}>
          ...
          <div style={{ marginTop: 12 }}>
            ...
            <div style={{ color: T.textSub, fontSize: 12, marginTop: 2 }}>
              @yago · Palermo · activo desde 2024
            </div>
          </div>
          ...
          >
            {[
              ["◆", "Host estrella", T.accent],
              ["✦", "10+ partidas", T.purple],
              ["★", "Puntual", T.green],
            ].map(([i, l, c]) => (
              <div
                key={l}
  ...
  const items = [
    {
      ...
      game: "Wingspan",
      when: "hace 5 min",
      preview: "¡Aceptado! Ya sos parte de la mesa.",
    },
    {
      type: "request",
      who: "Lucía",
      game: "Catan",
      when: "hace 23 min",
      preview: "Lucía quiere unirse a tu mesa",
      count: 2,
    },
    {
      type: "chat",
      ...
      game: "Spirit Island",
      when: "hace 1 h",
      preview: "Mariano: ¿alguien trae el manual de la expansión?",
    },
    {
      type: "chat",
      who: "Florencia",
      ...
      when: "hace 3 h",
      preview: "Florencia: dale, me sumo el sábado a las 9",
      count: 4,
    },
    {
      type: "accepted",
    ...
    },
    {
      ...
      game: "Root",
      when: "ayer",
      preview: "Sofía quiere unirse a tu mesa",
    },
  ];
  const meta = (type) => {
    if (type === "accepted")
      return { color: T.green, label: "ACEPTADA", icon: "✓" };
    if (type === "request")
      return { color: T.accentLight, label: "SOLICITUD", icon: "◆" };
        ...
        <div style={{ maxWidth: 820 }}>
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: 18 }}>
            {[
              ...
              >
                {l}
                <span style={{ color: T.textMute, fontWeight: 600 }}>{c}</span>
              </span>
            ))}
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      <span
                        style={{ ...fontDisp, fontWeight: 700, fontSize: 13 }}
                      >
                        {it.game}
                      </span>
                      <span
  ...
  const items = [
    {
      ...
      game: "Wingspan",
      when: "5m",
      preview: "Ya sos parte de la mesa.",
    },
    {
      type: "request",
      game: "Catan",
      when: "23m",
      preview: "Lucía quiere unirse",
      count: 2,
    },
    {
      type: "chat",
      game: "Spirit Island",
      when: "1h",
      preview: "Mariano: ¿alguien trae el manual?",
    },
    {
      type: "chat",
      game: "Terraforming Mars",
      when: "3h",
      preview: "Flor: me sumo el sábado",
      count: 4,
    },
    {
      type: "accepted",
    ...
    <_PhoneFrame theme={T.bg}>
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 11, color: T.accentLight, fontWeight: 700 }}>
            Limpiar
          </span>
        </div>
    ...
    >
      ...
      <div style={{ flex: 1, overflow: "auto", padding: "32px 56px" }}>
        <div style={{ maxWidth: 920 }}>
          ...
          <p style={{ color: T.textSub, fontSize: 14, margin: "0 0 28px" }}>
            Tu próxima partida es en 2 días. Y tenés 6 mesas hosteadas en total.
          </p>
          ...
          >
            ...
            <div style={{ flex: 1, position: "relative", zIndex: 1 }}>
              ...
              <div style={{ color: T.textSub, fontSize: 13 }}>
                {next.weekday} {next.dateShort} · {next.time} · {next.location}{" "}
                · {next.players + 1}/{next.maxPlayers + 1} jugadores
              </div>
            ...
            {past.map((t) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ★ 4.{5 + (t.seed % 4)} · {3 + (t.seed % 5)} comentarios
                  </div>
                </div>
                <Btn ghost sm>
                  Ver →
          ...
          >
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{ fontSize: 12, color: T.textSub }}>
                {next.weekday} {next.dateShort} · {next.time}
              </div>
              <div style={{ fontSize: 11, color: T.textMute, marginTop: 2 }}>
                {next.location} · {next.players + 1}/{next.maxPlayers + 1}
              </div>
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    >
                      {t.hosted ? "HOST" : "PLAYER"}
                    </span>
                  </div>
                  <div style={{ fontSize: 11, color: T.textSub, marginTop: 2 }}>
                    {t.weekday} {t.dateShort} · ★ 4.{5 + (t.seed % 4)}
                  </div>
                </div>
              </div>
            ))}
...
Object.assign(window, {
  TKLoginDesktop,
  TKLoginMobile,
  TKCreateTableDesktop,
  TKCreateTableMobile,
  TKProfileDesktop,
  TKProfileMobile,
  TKNotificationsDesktop,
  TKNotificationsMobile,
  TKFeedDesktop,
  TKFeedMobile,
});
