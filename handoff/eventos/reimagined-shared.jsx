...
const MOCK_EVENTS = [
  {
    ...
    description:
      "Tercera edición del clásico torneo de Catán. Tres rondas suizas + final a cuatro. Premios para el podio, sorteo entre participantes y mesa libre después del trofeo.",
    conditions:
      "Cupo confirmado al recibir el comprobante. Llegar 15 minutos antes del inicio. No se admiten reemplazos una vez sorteadas las mesas.",
    transferDetails:
      "Alias: turnocero.eventos\nCBU: 0000003100001234567890\nTitular: Turnocero SRL\nIncluí tu @ usuario en la referencia.",
    ...
    pendingRegs: [
      {
        ...
        initial: "N",
        color: "#1888ef",
        submittedAt: "2026-05-18T22:14:00",
        comprobanteType: "img",
      },
      {
        name: "Romina Vega",
        ...
        initial: "R",
        color: "#b48cff",
        submittedAt: "2026-05-19T09:42:00",
        comprobanteType: "pdf",
      },
      {
        name: "Pablo Suárez",
        ...
        initial: "P",
        color: "#f5a623",
        submittedAt: "2026-05-19T11:08:00",
        comprobanteType: "img",
      },
    ],
    rejectedRegs: [
      {
        ...
        initial: "T",
        color: "#5a6178",
        submittedAt: "2026-05-15T18:00:00",
        reviewedAt: "2026-05-16T10:00:00",
  ...
  },
  {
    ...
    description:
      "Junta abierta para jugar wargames de cualquier escala. Traé tu juego o sumate a una mesa armada.",
  ...
  },
  {
    ...
    description:
      "Cuarta fecha de la liga oficial 2026. Solo para inscriptos en la liga anual.",
  ...
  },
  {
    ...
    conditions:
      "Reservar lugar con anticipación. Sin reembolso una vez confirmado.",
  ...
  },
  {
    ...
    description:
      "Cuatro rondas, formato relajado. Apto para todos los niveles. Inscripción + pizza incluida.",
  ...
  },
  {
    ...
    description:
      "Demos del juego del año. Tres mesas paralelas a lo largo de la tarde.",
  ...
  },
  {
    ...
    description:
      "Cancelado por falta de cupo mínimo. Los inscriptos recibieron reembolso.",
