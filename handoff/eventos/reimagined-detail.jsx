...
function DetailScreen({ eventId, onBack, onOpenInscripciones }) {
  const evento = useMemo(
    () => MOCK_EVENTS.find((e) => e._id === eventId) || MOCK_EVENTS[0],
    [eventId],
  );
          ...
          <div className="detailMetaStrip">
            ...
            <div className="detailMetaCell">
              ...
              <span
                className="detailMetaValue"
                style={{
                  color: isFree ? "var(--green)" : "var(--text-primary)",
                }}
              >
            ...
            <div className="detailMetaCell">
              ...
              <span className="detailMetaValue">
                {hasMax
                  ? `${evento.participants} de ${evento.maxParticipants}`
          ...
          <section className="detailSection">
            ...
            <div className="hostCard">
              ...
              <div className="hostCardDetails">
                ...
                <div className="hostCardSub">
                  {evento.hostSub || `@${evento.hostHandle || "usuario"}`}
                </div>
              </div>
              <a
                href="#"
                onClick={(e) => e.preventDefault()}
                className="stubGhostBtn"
            ...
            <section className="detailSection">
              <div className="detailSectionHead">
                <span className="detailSectionLabel">
                  ◆ Inscriptos confirmados · {evento.confirmedRegs.length}
                </span>
                <span className="detailSectionRule" />
              </div>
          ...
          <div className="ticketStub">
            <div className="stubTop">
              ...
              {!isPast && evento.status === "open" && (
                <div
                  className={`stubCountdown ${cd.tone === "urgent" ? "urgent" : cd.tone === "soon" ? "soon" : ""}`}
                >
                  ● {cd.text}
                </div>
              )}
            ...
            <div className="stubBottom">
              <div className="stubRow">
                ...
                <span
                  className={`stubRowValue ${isFree ? "stubRowValueFree" : ""}`}
                >
                  {formatFee(evento.fee)}
                </span>
              </div>
              <div className="stubRow">
                ...
                <span className="stubRowValue">
                  {hasMax ? (
                    ...
                    `${evento.participants} sin límite`
                  )}
                </span>
              </div>
              {hasMax && (
                <div className="stubCuposBar">
                  <div
                    className={`stubCuposFill ${isFull ? "full" : ""}`}
                    style={{ width: `${fillPct}%` }}
                  />
                </div>
              )}
              <div className="stubRow">
                ...
                <span
                  className="stubRowValue stubRowValueAccent"
                  style={{
                    fontSize: 13,
              ...
              <div className="stubCtaBlock">
                {evento.isHost ? (
                  ...
                  <div className="stubCtaState confirmed">
                    <Icon.Check size={20} />
                    <span className="stubCtaStateTitle">
                      ¡Inscripción confirmada!
                    </span>
                    <span className="stubCtaStateSub">
                  ...
                  <div className="stubCtaState rejected">
                    ...
                    <span className="stubCtaStateSub">
                      Contactá al organizador para más info
                    </span>
                  </div>
                ) : evento.status === "cancelled" ? (
                  <button className="stubGhostBtn" disabled>
                    Evento cancelado
                  </button>
                ) : evento.status === "closed" ? (
                  <button className="stubGhostBtn" disabled>
                  ...
                  <div className="inscriptionForm">
                    <div>
                      ...
                      <p className="inscriptionFormText">
                        {evento.conditions || "Sin condiciones especiales."}
                      </p>
                    </div>
                    {!isFree && evento.transferDetails && (
                      <div>
                        <div className="inscriptionFormLabel">
                    ...
                    {!isFree && (
                      <div>
                        ...
                        <div
                          className="comprobanteDrop"
                          onClick={() => setHasComprobante(true)}
                        >
                          {hasComprobante ? (
                            <>
                              <Icon.Doc size={22} />
                              <span className="comprobanteDropText">
                                comprobante-pago.pdf
                              </span>
                              <span className="comprobanteDropSub">
                                Click para cambiar
                              </span>
                            </>
                          ) : (
                    ...
                    <div className="inscriptionActions">
                      ...
                      <button
                        className="stubCta"
                        disabled={!isFree && !hasComprobante}
                      >
                        Confirmar
                      </button>
                    </div>
                ...
                {userReg === "confirmed" && evento.transferDetails && (
                  <details style={{ marginTop: 8 }}>
                    ...
                    <div className="transferBox" style={{ marginTop: 8 }}>
                      {evento.transferDetails}
                    </div>
                  </details>
                )}
