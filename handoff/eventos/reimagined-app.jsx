...
function ReimaginedApp() {
  ...
  const openInscripciones = (id) => {
    setEventId(id);
    setScreen("inscripciones");
  };
  const goList = () => {
    setScreen("list");
  };
  ...
  const hostedId =
    MOCK_EVENTS.find((e) => e.pendingRegs?.length)?._id || MOCK_EVENTS[0]._id;
        ...
        <div className="switcher">
          ...
          <div className="switcherTabs">
            ...
            <button
              ...
              onClick={() => {
                setEventId(eventId || MOCK_EVENTS[0]._id);
                setScreen("detail");
              }}
            >
              Detalle
